...
_REASON_HINTS = {
    ...
    "bad_hook": "User rejected weak hooks — line 1 must state a concrete fact, not opinion.",
    "too_opinionated": "User rejected opinionated posts — report facts and numbers only, no speculation.",
