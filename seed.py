...
SEED_HEADLINES = [
    {
        ...
        "format": "BREAKING",
        "text": "Nvidia beat Q4 — $22.1B revenue vs $20.4B expected. Mostly data center again. $NVDA",
        "impact": "high",
        "category": "earnings",
        "tickers": "NVDA",
        "confidence": 0.93,
    },
    {
        ...
        "format": "CONTEXT",
        "text": "Fed held rates but now sees two cuts in 2026, up from one before. Slightly more dovish than expected. $SPY",
        "impact": "high",
        "category": "macro",
        "tickers": "SPY",
        "confidence": 0.90,
    },
    {
        ...
        "format": "BREAKING",
        "text": "Rivian sold 75M shares at ~$20 to raise $1.5B. Stock down ~15% on dilution fears. $RIVN",
        "impact": "high",
        "category": "earnings",
        "tickers": "RIVN",
        "confidence": 0.91,
    },
    {
        ...
        "format": "CONTEXT",
        "text": "OpenAI is reportedly raising $40B at a $300B valuation. Keeps the AI spending race going. $MSFT",
        "impact": "med",
        "category": "ai",
        "tickers": "MSFT",
        "confidence": 0.82,
    },
    {
        ...
        "format": "BREAKING",
        "text": "Tesla shareholders approved Musk's new pay package. Clears a governance overhang. $TSLA",
        "impact": "med",
        "category": "regulatory",
        "tickers": "TSLA",
        "confidence": 0.86,
